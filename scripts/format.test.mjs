...
test("field range is start to end, not a single day", async () => {
  ...
  assert.equal(fieldRangeLabel(undefined, "2026-09-01"), "01/09");
  assert.equal(fieldRangeLabel(null, "2026-09-01"), "01/09");
});
...
test("field period line is a plain sentence", async () => {
  ...
  assert.equal(fieldPeriodLine(undefined, "2026-09-01"), "Entrevistas em 01/09");
  assert.equal(fieldPeriodLine(null, "2026-09-01"), "Entrevistas em 01/09");
});
